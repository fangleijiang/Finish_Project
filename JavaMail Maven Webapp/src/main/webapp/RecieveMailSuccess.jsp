...
<div class="nav">
		...
		<div class="mail_pic"><img src="img/sentmail.png"></div><div class="mail_suc">收件箱</div>
		
		<p>
		 <input type="checkbox" id="selectAll"  
            onclick="checkall()"><label for="selectAll">全选</label>  <button  
            id="deleteAll" onclick="getIdStr()">删除</button>  
        <form action="mailaction!delete_recieve_mail.action" method="post" id="deleteForm">  
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0"
		...
		<tr style="background-color: #DBDBD4" height="30px">
		 ...
		 <s:iterator value="list_recieveMail" var="mail">
		<tr onmousemove=javascript:changebg(this,0)
			...
			<td width="10%"><s:property value="#mail.mail_from"/></td>
			<td width="50%">
			<a href="mailaction!find_recievemail_by_id.action?mail.id=${mail.id}">
          ...
          <s:iterator value="pageBean">
                        ...
                        <s:else>
                        <a href="List_recieveMail.action?currentPage=1"><FONT color="black">第一页</FONT></a>
                        
                         <a href="List_recieveMail.action?currentPage=<s:property value="%{currentPage-1}"/>"><FONT color="black">上一页</FONT></a>
                        </s:else>
                        <s:if test="%{currentPage != totalPage}">
                         <a href="List_recieveMail.action?currentPage=<s:property value="%{currentPage+1}"/>"><FONT color="black">下一页</FONT></a>
                         <a href="List_recieveMail.action?currentPage=<s:property value="totalPage"/>"><FONT color="black">最后一页</FONT></a>
