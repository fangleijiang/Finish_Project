...
<div class="nav">
		...
		<div class="mail_pic"><img src="img/sentmail.png"></div><div class="mail_suc">已发邮件</div>
		<p>
		 <input type="checkbox" id="selectAll"  
            onclick="checkall()"><label for="selectAll">全选</label>  <button  
            id="deleteAll" onclick="getIdStr()">删除</button>  
        <form action="mailaction!delete_sent_mail.action" method="post" id="deleteForm">  
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0"
		...
		<tr style="background-color: #DBDBD4" height="30px">
		 ...
		 <s:iterator value="list_sent_mail" var="mail">
		<tr onmousemove=javascript:changebg(this,0)
          ...
          <s:iterator value="pageBean">
                        ...
                        <s:else>
                        <a href="list_sent_mail.action?currentPage=1"><FONT color="black">第一页</FONT></a>
                        
                         <a href="list_sent_mail.action?currentPage=<s:property value="%{currentPage-1}"/>"><FONT color="black">上一页</FONT></a>
                        </s:else>
                        <s:if test="%{currentPage != totalPage}">
                         <a href="list_sent_mail.action?currentPage=<s:property value="%{currentPage+1}"/>"><FONT color="black">下一页</FONT></a>
                         <a href="list_sent_mail.action?currentPage=<s:property value="totalPage"/>"><FONT color="black">最后一页</FONT></a>
